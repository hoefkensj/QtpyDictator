...
def Assets():
	...
	def QtBlocks():
		...
		def Layouts():
			...
			def center(child,	**k):
				...
				lSpcFix= QtBlocks.Widgets.SpcFix(w=w)
				rSpcFix= QtBlocks.Widgets.SpcFix(w=w)
				wgt= QtBlocks.Elements.Wgt(t='h')
		...
		def Widgets():
			def SpcFix(**k):
				...
				wgt.SpcFix = QtBlocks.Elements.Spcr(	w=w, h=h, t=[hPol,vPol])
			...
			def SpcEx(**k):
				...
				def create(wgt):
					wgt.SpcEx = QtBlocks.Elements.Spcr(w=w, h=h, t=[hPol,vPol])
					return wgt
				def layout(wgt):
					wgt = QtBlocks.Layouts.sPol(wgt, h='P', v='P')
					return wgt
				def add(wgt):
				...
				wgt = QtBlocks.Elements.Wgt(n=f'wgtSpcEx{n}',t='h')
				wgt=create(wgt)
				wgt=layout(wgt)
				wgt.lay=add(wgt)
			...
			def chkRE(**k):
				def create(wgt):
					wgt.chkRE 		= QtBlocks.Elements.chkBox('RE',h=15,w=15)
					return wgt
				def layout(wgt):
					wgt = QtBlocks.Layouts.sPol(wgt, h='P', v='P')
					wgt.setContentsMargins(*margin)
				...
				wgt =	 QtBlocks.Elements.Wgt(n='wgtRE',t='h')
				wgt=create(wgt)
			...
			def Tree(*a,**k):
				def create(wgt):
					wgt.Tree 		= QtBlocks.Elements.Tree(n='Tree',margin=margin)
					return wgt
				def layout(wgt):
					wgt =QtBlocks.Layouts.sPol(wgt, h='E', v='mE')
				...
				margin=k.get('margin') or  [0,0,0,0]
				wgt =	QtBlocks.Elements.Wgt(n=name,t='h')
				wgt=create(wgt)
				wgt=layout(wgt)
				wgt.lay=add(wgt,wgt.lay)
				wgt=fnx(wgt)
			...
			def IncDec(**k):
				def create(wgt):
					wgt.btnExp 		= QtBlocks.Elements.iBtn('Inc',h=15,w=15)
					wgt.btnCol 		= QtBlocks.Elements.iBtn('Dec',h=15,w=15)
					return wgt
				def layout(wgt):
					wgt = QtBlocks.Layouts.sPol(wgt, h='P', v='P')
					wgt.setContentsMargins(*margin)
				...
				wgt =	 QtBlocks.Elements.Wgt(n='wgtIncDec',t='h')
				wgt=create(wgt)
				wgt.lay=add(wgt,wgt.lay)
				wgt=layout(wgt)
				wgt=conn(wgt)
			...
			def Search():
				def create(wgt):
					wgt.btnNext 			= QtBlocks.Elements.iBtn('Next', w=12)
					wgt.btnPrev 			= QtBlocks.Elements.iBtn('Prev', w=12)
					wgt.btnSearch 		= QtBlocks.Elements.iBtn('Search')
					wgt.chkRegEx			=	Wgt.chkRE()
					wgt.txt 					=	QtBlocks.Elements.ledit('Search')
					wgt.wgtPN 				= QtBlocks.Layouts.siblings([wgt.btnPrev,wgt.btnNext],t='h',margin=[0,0,0,0])
					wgt.wgtCtl			 	= QtBlocks.Layouts.siblings([wgt.wgtPN,wgt.btnSearch],t='h',margin=[0,0,0,0])

					wgt.wgtSearch			= QtBlocks.Layouts.siblings([wgt.chkRegEx,wgt.txt,wgt.wgtCtl,],t='h',margin=[0,0,0,0])
					return wgt
				def add(wgt,lay):
				...
				def init(wgt):
					...
					wgt	= QtBlocks.Layouts.sPol(wgt, h='E', v='F')
					wgt.Found = None
					return wgt
				def fnx(wgt):
					def dispPN(wgt):
				...
				def conn(wgt):
					...
					return wgt
				wgt = QtBlocks.Elements.Wgt(n='Search',t='h')
				wgt = create(wgt)
				wgt.lay = add(wgt,wgt.lay)
				wgt = init(wgt)
				wgt =	fnx(wgt)
			...
			def EditProp(n,**k):
				...
				def create(wgt):
					wgt.lbl 		= QtBlocks.Elements.lbl(f'{n}:')
					wgt.txt 		= QtBlocks.Elements.ledit(n,ro=True)
					wgt.txtdup	= QtBlocks.Elements.ledit(n,ro=True)
					wgt.btnSet 	= QtBlocks.Elements.tBtn('Set')
					wgt.btnEdit =	QtBlocks.Elements.iBtn('Edit', bi=True)
					return wgt
				def add(wgt):
				...
				def conn(wgt):
					...
					return wgt
				wgt 		=	QtBlocks.Elements.Wgt(n=n,t='h')
				wgt 		= create(wgt)
				wgt.lay = add(wgt)
			...
			def AppCtl(**k):
				def create(wgt):
					wgt.hSpc			=	Wgt.SpcEx()
					wgt.btnExit		= QtBlocks.Elements.tBtn('Exit')
					wgt.btnSave		=	QtBlocks.Elements.tBtn('Save As')
					wgt.btnPrint	=	QtBlocks.Elements.tBtn('Print')
					return wgt
				def add(wgt,lay):
				...
				def init(wgt):
					...
					wgt= QtBlocks.Layouts.sPol(wgt,h='E',v='P')
					return wgt
				def fnx(wgt):
				...
				wgt = QtBlocks.Elements.Wgt(n='wgtAppCtl',t='h')
				wgt=create(wgt)
				wgt.lay=add(wgt,wgt.lay)
				wgt=fnx(wgt)
				wgt=init(wgt)
			...
			Wgt.AppCtl		=	AppCtl
			return Wgt
		QtBlocks = types.SimpleNamespace()
		QtBlocks.Elements	=	Elements()
		QtBlocks.Layouts		=	Layouts()
		QtBlocks.Widgets		=	Widgets()
		return QtBlocks
	...
	ico					=		{
			'Search'  : { 'L' :	b'' ,
										'D'	:	b''},
			'Next'    :	{ 'L' :	b'' ,
										'D'	:	b''},
			'Prev'    :	{ 'L' :	b'',
										'D'	:	b''},
			'Inc'     : { 'L' :	b'PHN2ZyB3aWR0aD0iMTYiIGhlaWdodD0iMTYiIGVuYWJsZS1iYWNrZ3JvdW5kPSJuZXciIHZlcnNpb249IjEuMSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KIDxyZWN0IHg9IjIiIHk9IjciIHdpZHRoPSIxMSIgaGVpZ2h0PSIxIiBmaWxsPSIjMzYzNjM2Ii8+Cjwvc3ZnPgo=',
										'D'	:	b''},
			'Dec'     :	{ 'L' :	b'',
										'D'	:	b''},
			'Edit'    :	{ 'L' :	b'',
										'D'	:	b''},
			'Copy'    : { 'L' :	b'',
										'D'	:	b''},
			'RegEx'		:	{ 'L' :	b'',
										'D'	:	b''},
			}
	lays				=		{
	...
	Assets.ico				=	ico
	Assets.lays			=	lays
	Assets.fndummy		= dummy
	Assets.QtBlocks	= QtBlocks()
...
def construct_Qt5Ui(data,beta):
	def Qt5Ui():
		Qt5Ui=types.SimpleNamespace()
		Qt5Ui.App			=	QtWidgets.QApplication(sys.argv)
		Qt5Ui.Assets	=	Assets()
		Qt5Ui.Fnx			= Fnx()
